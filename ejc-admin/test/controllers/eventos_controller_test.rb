...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { dta_evento: @evento.dta_evento, imagem: @evento.imagem, informacoes: @evento.informacoes, titulo: @evento.titulo } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { dta_evento: @evento.dta_evento, imagem: @evento.imagem, informacoes: @evento.informacoes, titulo: @evento.titulo } }
