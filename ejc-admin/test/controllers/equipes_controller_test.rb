...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference('Equipe.count') do
      post equipes_url, params: { equipe: { ano: @equipe.ano, nome: @equipe.nome, observacoes: @equipe.observacoes } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { ano: @equipe.ano, nome: @equipe.nome, observacoes: @equipe.observacoes } }
